...
public class Activity8 {
    ...
    public void navigateToContact() throws InterruptedException {
        ...
        //Fill the form
        driver.findElement(By.xpath("//div/div/label[contains(text(),'Full Name')]/following-sibling::input")).sendKeys("pacha");
        driver.findElement(By.xpath("//div/div/label[contains(text(),'Email')]/following-sibling::input")).sendKeys("pacha@gmail.com");
